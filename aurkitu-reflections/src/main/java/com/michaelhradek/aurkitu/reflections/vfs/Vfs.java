package com.michaelhradek.aurkitu.reflections.vfs;
 ...
 * </pre>
 * <p>use {@link Vfs#findFiles(java.util.Collection, com.google.common.base.Predicate)} to get an
    ...
    public static Iterable<File> findFiles(final Collection<URL> inUrls, final Predicate<File> filePredicate) {
        ...
        for (final URL url : inUrls) {
            try {
                ...
                if (Reflections.log != null && Reflections.log.isErrorEnabled()) {
